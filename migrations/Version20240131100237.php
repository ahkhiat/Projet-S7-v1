 ...
 */
final class Version20240131100237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE date_naissance date_naissance DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE date_naissance date_naissance DATE DEFAULT NULL');
    }
}
